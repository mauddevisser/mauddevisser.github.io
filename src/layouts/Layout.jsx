...
function Layout() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#F4EEED]">
            <header className={`relative md:sticky top-0 z-50 w-full transition-all duration-300 ${
                isScrolled
                    ? "70 backdrop-blur-md md:pt-6 "
                    : "bg-transparent md:py-6"}`}>
                <nav
                    className={`flex flex-col md:flex-row ml-0 justify-between items-center bg-[#DFB5A6] md:px-10 py-6 md:py-5 md:rounded-2xl md:max-w-7xl mx-2 md:mx-auto w-full transition-all duration-300 ${
